...
const DASHBOARD_FEATURES: Array<{
  ...
  { title: "اطلاعات شرکت", description: "اطلاعات تماس و معرفی Galaxy Technology", icon: "M3 21h18M6 18V3h12v15M9 21v-6h6v6", color: "from-slate-500 to-gray-600", page: "developer" },
];
